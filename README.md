...
![REST%20API](https://img.shields.io/badge/REST%20API-02569B?style=for-the-badge&logo=fastapi&logoColor=white)
...
**[OMR Scanner](https://github.com/sujit70777/omr_scanner_flutter)** — Fully offline exam answer-sheet scanner. Uses registration-mark alignment and homography rather than OCR: calibrate the bubble grid once per sheet layout, then scan with live camera guidance and auto-capture for instant per-roll scoring.

**[Jatri — Bangladesh Transit App](https://github.com/sujit70777/Jatri---Bangladesh-Transit-App)** — Journey planner and ticketing app built on real MRT Line 6 and BRTA route data. Search, route results, itinerary detail and ticket purchase flow.

**[ar_measure](https://github.com/sujit70777/ar_measure)** — Cross-platform AR measurement plugin for Flutter, wrapping ARKit and ARCore. Place anchors, read live real-world distances and areas.

<br>

## Shipped Work

**[Farenow](https://play.google.com/store/apps/details?id=com.app.farenow)** — Multi-service super app for a US client (Houston, TX): ride-hailing, on-demand bookings, food and grocery delivery, consultations, and marketplace listings in one Flutter app.

**Tanto** — Brazilian corporate reimbursement platform: AI invoice-token capture validated against SEFAZ state tax agencies, policy checks, and instant Pix payout. *(Company closed Sept 2025; listings removed.)*
